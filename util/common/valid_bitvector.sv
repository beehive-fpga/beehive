module valid_bitvector #(
    ...
    // When 1, the vector resets to all-ones. Default 0 preserves the original
    // reset-to-zero behavior for existing instantiations that don't set it.
    ,parameter INIT_TO_ONE = 0
)(
     input clk
    ,input rst
